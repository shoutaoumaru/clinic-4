            ...
            <ul class="pc-nav-list">
              ...
              <li class="pc-nav-item">
                <a class="pc-nav-link animsition-link" href="<?php echo esc_url( home_url('/about')); ?>"
                  ><span>わたしたちについて</span></a
                >
              </li>
              <li class="pc-nav-item">
                <a
                  class="pc-nav-link animsition-link"
                  href="<?php echo esc_url( home_url('/clinic')); ?>
                  ><span>医院案内</span></a
                >
              </li>
              <li class="pc-nav-item">
                <a class="pc-nav-link animsition-link" href=" <?php echo esc_url( home_url('/menu')); ?>"
                  ><span>診療案内</span></a
                >
              </li>
              <li class="pc-nav-item">
          ...
          <div class="faq">
            <div class="faq__inner">
              ...
              <dl class="faq__block">
                ...
                <div class="faq__item">
                  <dt class="js-accordion-title ac-title">
                    <span class="c-txt-md">駐車場はありますか？ </span>
                  </dt>
                  <dd class="ac-content">
                    <div class="m-description-article">
                      <p class="c-txt-md">
                        はい。クリニック裏に10台分の駐車スペースがございます。駐輪場もございますので、お近くの方は自転車でもお越しいただけます。
                      </p>
                    </div>
                  </dd>
                </div>
        ...
        <div class="p-footer__wrap">
          <div class="p-footer__block">
            <ul class="p-footer__list">
              ...
              <li class="p-footer__item">
                <a
                  class="p-footer__link animsition-link"
              ...
              <li class="p-footer__item">
                <a class="p-footer__link animsition-link" href=" <?php echo esc_url( home_url('/menu')); ?>"
                  >診療案内</a
                >
              </li>
              <li class="p-footer__item">
                <a class="p-footer__link animsition-link" href="<?php echo esc_url( home_url('/news')); ?>"
                  >お知らせ</a
                >
              </li>
              <li class="p-footer__item">
