...
<body class="animsition">
  <div id="main-wrapper" class="superwrapper">
      ...
      <div class="pc-container">
        ...
        <nav class="pc-nav">
          <ul class="pc-nav-list">
            ...
            <li class="pc-nav-item">
              <a class="pc-nav-link animsition-link" href=" <?php echo esc_url( home_url('/treatment')); ?>"><span>診療案内</span></a>
            </li>
            <li class="pc-nav-item">
    ...
    <div id="main-contents">
      ...
      <section class="p-policy">
        <div class="c-container">
          <div class="p-policy-wrap appear up">
            <div class="p-policy__img item">
              <img class="parallax-up" src="<?php echo get_template_directory_uri(); ?>/images/home/medical__4@pc.jpg">
            </div>
            <div class="p-policy-container">
              <div class="p-policy__title clip-js left">
                <h2 class="title">POLICY</h2>
              </div>
              <div class="p-policy__desc item">
                <h3 class="subtitle">患者様の満足のために</h3>
                <p class="c-txt-sm">
                  私たちが何よりもまず目指すところは“患者様の満足のために”。<br>
                  当院では<span class="c-line01">患者様の満足を一番に考えております。</span>患者様はさまざまな思いを抱えて来院されます。
                </p>
              </div>
              <div class="p-policy__text item">
                <p class="c-txt-sm">
                  それらを解決するために診察・治療技術の研鑽はもちろん、そのための環境を十分に整えてお待ちしております。その上で私たちがより大事にしているもの、それは痛くない、怖くない、通いやすいクリニックであることです。
                </p>
                <div class="p-policy__btn c-btn01">
                  <a class="c-btn01__link animsition-link" href="<?php echo esc_url( home_url('about')); ?>">わたしたちについて</a>
                </div>
              </div>
            </div>
          </div>
      ...
      <section class="p-message">
        <div class="c-container">
          <div class="p-message-wrap">
            <div class="p-message__img appear up">
              <img class="item" src="<?php echo get_template_directory_uri(); ?>/images/home/staff__1@sp.jpg" alt="">
              <div class="p-message__name item">
                <p class="c-txt-md small">院長</p>
                <p class="c-txt-md">利部 翔太</p>
              </div>
            </div>
            <section class="p-message-container appear up">
              <h2 class="title clip-js left">
                MESSAGE
              </h2>
              <p class="subtitle item"><span class="subtitle__black ">痛くない、怖くない、</span><br>
                通いやすい医院を<br>
                目指しています</p>
              <p class="c-txt-sm item">
                耳鼻咽喉科疾患は、症状を何度も繰り返したり、症状が長く続くこともあります。また、お子様からご年配の方まで幅広い年齢層の方が対象となります。それ故、それぞれの患者様に合った治療方針や治療方法を十分に説明し、同意をえた上で行うことが大切であると考えています。<br>
                当院のコンセプト“健康を育み、ゆたかな未来へ”には、みなさんの健康意識を高め、より多くの方を健康的に保つことで、次世代のゆたかなまちづくりに貢献したいという想いが込められています。
              </p>
              <div class="p-message__btn c-btn01 item">
                <a class="c-btn01__link animsition-link" href="<?php echo esc_url( home_url('/clinic')); ?>">院長紹介</a>
              </div>
            </section>
          </div>
        </div>
      ...
      <section class="p-promise">
        <div class="c-container">
          <h2 class="p-promise__title clip-js left">当院の<span class="brown">3</span>つのお約束
          </h2>
          <p class="p-promise__cover  clip-js left">promise</p>
          <ul class="p-promise__list appear up">
            <li class="p-promise__list__item item">
              <div class="p-promise__list__img"><img src="<?php echo get_template_directory_uri(); ?>/images/home/medical__2@pc.jpg" alt=""></div>
              <div class="p-promise__list__txtarea">
                <p class="p-promise__list__txt">
                  耳鼻咽喉科の専門医として</p>
              </div>
            </li>
            <li class="p-promise__list__item item">
              <div class="p-promise__list__img"><img src="<?php echo get_template_directory_uri(); ?>/images/home/naisikyo2.jpg" alt=""></div>
              <div class="p-promise__list__txtarea">
                <p class="p-promise__list__txt">からだに優しい内視鏡検査</p>
              </div>
            </li>
            <li class="p-promise__list__item item">
              <div class="p-promise__list__img"><img src="<?php echo get_template_directory_uri(); ?>/images/home/counseling.jpg" alt=""></div>
              <div class="p-promise__list__txtarea">
                <p class="p-promise__list__txt">皆様のかかりつけ医として</p>
              </div>
            </li>
          </ul>
        </div>
      ...
      <section class="p-guidance">
        <div class="c-container">
          <div class="c-head03">
            <h2 class="p-guidance__title clip-js left">
              INFORMATION
            </h2>
            <h3 class="p-guidance__subtitle  clip-js left">診察案内</h3>
          </div>
          <div class="p-guidance__wrap appear up">
            <ul class="p-guidance__list item">
              <li class="p-guidance__item ">
                <p class="c-txt-md">一般内科</p>
              </li>
              <li class="p-guidance__item ">
                <p class="c-txt-md">耳鼻咽喉科</p>
              </li>
              <li class="p-guidance__item ">
                <p class="c-txt-md">各種検診・診査</p>
              </li>
              <li class="p-guidance__item ">
                <p class="c-txt-md">予防接種</p>
              </li>
            </ul>
            <div class="p-guidance__btn c-btn01 item">
              <a class="c-btn01__link animsition-link" href=" <?php echo esc_url( home_url('menu')); ?>">診察案内</a>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="gallery" class="p-gallery">
        <div class="c-container">
          ...
          <div class="p-gallery__slider hero">
            <div class="swiper-container2">
              <div class="swiper-wrapper">
                <div class="swiper-slide second">
                  <img src="<?php echo get_template_directory_uri(); ?>/images/home/room@pc.jpg" />
                </div>
                <div class="swiper-slide second">
                ...
                <div class="swiper-slide second">
                  <img src="<?php echo get_template_directory_uri(); ?>/images/home/toilet.jpg" />
                </div>
                <div class="swiper-slide second">
                  <img src="<?php echo get_template_directory_uri(); ?>/images/home/rentogen.jpg" />
                </div>
              </div>
            </div>
          </div>
      ...
      <section id="recruit" class="p-recruit">
        <div class="c-container">
          <div class="p-recruit__wrap appear up">
            <div class="p-recruit__txtarea item">
              <div class="c-head02">
                <h2 class="title clip-js left">
                  RECRUIT
                </h2>
                <p class="subtitle"><span>地域社会のために、<br>そしてスタッフのために。</span>
                </p>
              </div>
            </div>
            <div class="p-recruit__btn c-btn01 item">
              <a class="c-btn01__link animsition-link" href=" <?php echo esc_url( home_url('ricruit')); ?>">採用情報</a>
            </div>
          </div>
          <div class="p-recruit__left clip-js1 left">
            <img src="<?php echo get_template_directory_uri(); ?>/images/home/counseling-2.jpg" alt="">
          </div>
          <div class="p-recruit__right">
            <img class="parallax-down" src="<?php echo get_template_directory_uri(); ?>/images/home/clinic2.jpg" alt="">
          </div>
        </div>
      </section>
      <!-- /.p-recruit -->
        ...
        <div class="c-container">
          ...
          <div class="p-access-container appear up">
            <div class="p-access-wrap item">
              <h3 class="p-access-txt">
                <p class="c-txt-sm">医院案内</p>
              </h3>
              <h4 class="p-access__name">
                RivRound医院
              </h4>
        ...
        <div class="c-container">
          <div class="p-news__wrap appear up">
            <h2 class="p-news__title clip-js left">
              ...
              <p class="ja">
                <a class="p-news__home-link animsition-link" href="<?php echo esc_url( home_url('news')); ?>">お知らせ一覧</a>
              </p>
            </h2>
            <ul class="p-news__block item">
              <?php query_posts('posts_per_page=3'); ?>
              <?php if(have_posts()) : while(have_posts()) : the_post(); ?>
                <li class="p-news__item ">
                  <a class="p-news__link" href="<?php the_permalink() ;?>">
                    <p class="p-news__date"><?php echo get_the_date(); ?></p>
            ...
            <div class="ft-info__wrap">
              <div class="ft-info__btns">
                <p class="ft-info__reservation c-btn03 ">
                  <a class="c-btn03__link" href="#" target="_blank" rel="noopener noreferrer">
